package com.example.luisp.serviciosweb;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    // IP de mi Url
    String IP = "https://lpgarcia.000webhostapp.com";
                ...
                try {
                    ...
                    if (respuesta == HttpURLConnection.HTTP_OK) {
                        ...
                        if (resultJSON == "1") {      // hay un alumno que mostrar
                            ...
                            Toast.makeText(getApplicationContext(),"Alumno insertado correctamente",Toast.LENGTH_SHORT).show();
